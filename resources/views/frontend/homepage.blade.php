                ...
                <div class="services-wrapper mt-40">
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            <h4>Pasti diskon </h4>
                            <p>Pasti diskon 20% untuk pembelian 10 orang pertama🎉 </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            <h4>24/7 Admin</h4>
                            <p>Kami sedia 24/7 untuk memudahkan anda mebuat aquarium impian💖 </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            ...
                            <p>Tenang,barang kami sudah melakukan double seleksi hingga memastikan kualitas terbaik </p>
                        </div>
                    </div>
                </div>
            </div>
